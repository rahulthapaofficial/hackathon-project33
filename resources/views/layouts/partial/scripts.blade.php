...
<script src="https://demos.ui-lib.com/gull/dist-assets/js/scripts/dashboard.v1.script.min.js"></script>
<script src="{{ asset('public/dashboard/libraries/sweetalert2/sweetalert2.all.min.js') }}"></script>
<script src="https://demos.ui-lib.com/gull/dist-assets/js/scripts/form.validation.script.min.js"></script>
